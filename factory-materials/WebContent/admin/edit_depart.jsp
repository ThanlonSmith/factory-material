	...
	<div class="container">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">部门信息编辑</li>
			</ol>
			<form action="<%=path%>/UpdateDepartmentInfoServ" method="POST"
				class="col-md-4 col-md-offset-4">
				<div class="form-group ">
					<label for="exampleInputEmail1">您正在修改的是部门编号为<%
					...
					<input type="input" class="form-control" id="exampleInputEmail1"
						placeholder="请输入您要修改的部门名子" name="name">
				</div>
				<button type="submit" class="btn btn-primary"
					style="background: #a94442">修改</button>
				<a class="btn btn-primary" style="background: #a94442"
					href="http://localhost:8080/factory-materials/DepartmentInfoServ">取消</a>
			</form>
