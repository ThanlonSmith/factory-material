			...
			<div class="col-md-4 col-md-offset-4">
				...
				<div class="panel panel-primary" style="border-color: #a94442">
					<div class="panel-heading" style="background: #a94442">
						<span class="glyphicon glyphicon-user"></span>仓库管理员登录
					</div>
					<div class="panel-body">
						<form action="<%=path%>/GodownLoginServ" method="POST" name="loginForm">
							...
							<a href="/factory-materials/"
								style="color: green; font-weight: bold">重新选择角色!</a>
						</form>
					</div>
				</div>
			</div>
